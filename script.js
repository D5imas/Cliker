...
let gameState = {
    ...
    upgrades: {
        ...
        'double-click': { level: 0, cost: 2000000000, effect: 2, name: 'Двойной клик', description: 'Удваивает силу клика' },
    ...
    cases: {
        ...
        'premium': { name: 'Премиум кейс', cost: 10, emotions: ['💎', '👑', '⭐'], currency: 'duplicateShards' }
    },
    shop: {
...
let replicas = [
    ...
    "😉 Эта реплика дарит тебе подмигивающий смайлик!",
